...
class ImageGenerator {
    ...
    async generateImagePromptWithGemini(post) {
        try {
    ...
    async generateWithDalle3(prompt, postId) {
    ...
    async generateAllImages(contentCalendarPath = './content-calendar.json') {
        try {
            const data = await promises_1.default.readFile(contentCalendarPath, 'utf-8');
