  ...
  return (
    <div className="min-h-screen bg-yellow-50">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8">
        {posts.length === 0 ? (
          <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_black] p-12 text-center">
            <div className="bg-black text-white p-4 uppercase text-sm tracking-wider -mt-12 -mx-12 mb-8">
              <span>BLOG STATUS</span>
              <span className="float-right text-[#FF6600]">LOADING</span>
            </div>
            <h2 className="text-2xl font-bold text-black uppercase tracking-wider mb-4">
              Content Loading...
            </h2>
            <p className="text-black text-sm mb-6">
              New blog posts are being generated. Check back soon!
            </p>
            <Link
              href="/"
